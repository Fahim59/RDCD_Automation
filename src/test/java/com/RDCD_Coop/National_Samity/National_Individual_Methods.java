...
public class National_Individual_Methods extends BaseClass {
    ...
    @Test(description = "This is for shomiti create(Sodossho nibondhon) scenario", dataProvider = "Sodossho_Nibondhon_National", dataProviderClass = DataProviderClass.class, priority =6, enabled = false)
