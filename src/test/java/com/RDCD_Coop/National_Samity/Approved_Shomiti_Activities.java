...
public class Approved_Shomiti_Activities extends BaseClass {
    ...
    public static String AuthorizePerson = "৩ - মোস্তাফিজুর রহমান2941";
    ...
    @Test(description = "This is for selecting authorize person scenario", priority = 1, enabled = true)
    public static void Shomiti_AuthorizePersonSelect() throws InterruptedException {
        ...
        SmallWait();
        SelectBy_Name_VisibleText("samityName", sname+" - "+"জাতীয় সমিতি");

        SelectBy_Name_VisibleText("nationalMemberId","রূপসা বিত্তহীন সমবায় সমিতি - ( Nielsen Bangladesh Ltd.-মোস্তাফিজুর রহমান )");

        SelectBy_Name_VisibleText("primaryMemberId","CHANGE foundation - ( মোস্তাফিজুর রহমান )");

        SelectBy_Name_VisibleText("primarySamityMemberId", AuthorizePerson);
