package com.RDCD_Coop.National_Samity;
...
public class Create_National_Shomiti extends BaseClass {
    ...
    public static void NameClearance(String division, String district, String upazilla, String sType) throws InterruptedException {
        ...
        for(WebElement option : user){
            ...
            if(option.getAttribute("value").equalsIgnoreCase("N")){
    ...
    @Test(description = "This is shomiti name clearance approve scenario", priority =3, enabled = true) //Address
    ...
    @Test(description = "This is for shomiti create(Prathomik Tottho) scenario",dataProvider = "Initial_Info", dataProviderClass = DataProviderClass.class, priority =4, enabled = true) //Address
    public static void PrathomikTottho(String union,String address,String election_area,String work_area,String work_address,String date,String fee,String share,String sharePrice,String sellShare,String phone,String mobile,String email,String enterprise,String project,String website) throws InterruptedException {
        ...
        if(size > 0){
            ...
            SmallWait();
            SelectBy_Name_Radiobox("samityLevel","N"); //Shomiti Level
            ...
            SmallWait();
            SelectBy_Name_Radiobox("samityLevel","N");
    ...
    @Test(description = "This is for shomiti create(Sodossho nibondhon) scenario", dataProvider = "Sodossho_Nibondhon_National", dataProviderClass = DataProviderClass.class, priority =6, enabled = true)
    ...
    @Test(description = "This is for shomiti create(committee bebosthapona) scenario", dataProvider = "Committee_Bebosthapona_National", dataProviderClass = DataProviderClass.class, priority =7, enabled = true)
    ...
    public static void Shomiti_Approval() throws InterruptedException {
        ...
        officeType.click();
        officeType.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);

        //সমবায় অধিদপ্তর
        WebElement office = driver.findElement(By.xpath("(.//*[@role='combobox'])[2]"));
        office.click();
        office.sendKeys(Keys.ARROW_DOWN, Keys.ENTER);

        //ড. মোঃ হারুন-অর-রশিদ বিশ্বাস - নিবন্ধক ও মহাপরিচালক
        WebElement person = driver.findElement(By.xpath("(.//*[@role='combobox'])[3]"));
        person.click();
        person.sendKeys(Keys.ARROW_DOWN,Keys.ARROW_DOWN, Keys.ENTER);
