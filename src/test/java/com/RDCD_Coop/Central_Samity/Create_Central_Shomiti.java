...
public class Create_Central_Shomiti extends BaseClass {
    ...
    @Test(description = "This is for shomiti create(Sodossho nibondhon) scenario", dataProvider = "Sodossho_Nibondhon_Central", dataProviderClass = DataProviderClass.class, priority =6, enabled = true)
